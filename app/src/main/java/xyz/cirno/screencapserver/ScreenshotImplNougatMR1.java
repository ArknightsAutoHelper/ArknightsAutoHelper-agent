...
public class ScreenshotImplNougatMR1 implements IScreenshotImpl {
    // implementation for Nougat MR1 (API 25)
    // exposes color space internally, but no color management
    // max 2 displays
    ...
    public ScreenshotImplNougatMR1() {
        try {
